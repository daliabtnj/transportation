...
public class driver2 {
    ...
    /**
     * Copies an array of Transportation objects.
     *
     * @param transport The array of Transportation objects to be copied.
     * @return A copy of the input array.
     */
    public static Transportation[] copyTheObject(Transportation[] transport) {
        Transportation[] copyTransport = new Transportation[transport.length];
        for (int i = 0; i < transport.length; i++) {
            copyTransport[i] = new Transportation(transport[i]);
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
 		...
 		// test copy the object method
 	
 		System.out.println(copyTheObject(mixedArray2));
 		System.out.println(copyTheObject(mixedArray1));
